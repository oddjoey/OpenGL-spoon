...
//		->SetSpeed(3.0f)
//		->SetSensitivity(0.1f)
//		->SetMousePosition(pGM->GetScreenSize(eSize::HALF))
//		->SetViewAngles(glm::vec2(-90.0f, 0.0f));
//
//	/************************************************************************
//	*************************************************************************
//	************************************************************************/
...
//		//model = glm::rotate(model, (GLfloat)glfwGetTime() * glm::radians(63.0f), glm::vec3(0.0f, 1.0f, 0.0f));
//
...
//		glm::mat4 projection = glm::perspective(glm::radians(65.0f), (GLfloat)(pGM->GetScreenSize(eSize::FULL).x / pGM->GetScreenSize(eSize::FULL).y), 0.1f, 100.0f);
//
//		/***********************************************************************
//		****					RENDERING DONE HERE							****
//		***********************************************************************/
